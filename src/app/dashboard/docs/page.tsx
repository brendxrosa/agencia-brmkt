...
import { Plus, X, Search, FileText, Bold, Italic, Underline, Link, Upload, Trash2, Eye, Edit2, Save, ExternalLink, Send, CheckCircle, Clock, Settings } from 'lucide-react'
      ...
      <Modal open={!!docVisualizar} onClose={() => setDocVisualizar(null)}>
        {docVisualizar && (
          <div className="p-6">
            ...
            {docVisualizar.conteudo && <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed mb-6" dangerouslySetInnerHTML={{ __html: docVisualizar.conteudo }} />}
